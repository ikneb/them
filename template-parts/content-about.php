                    ...
                    <article class="uk-article" >
                      <div>
                        <div class="tm-panel-header uk-margin-large-bottom uk-text-center">
                            <h2 class="uk-panel-title"><?php echo get_cat_name(12) ?></h2>
                            <p class="tm-panel-header-subtitle uk-margin-small-top"><h1><?php echo category_description(12)?></h1></p>
                        </div>
                        <p>
        ...
        <section class="tm-bottom-c uk-grid" data-uk-grid-match="{target:'> div > .uk-panel'}" data-uk-grid-margin>
            <div class="uk-width-1-1">
                <div class="uk-panel">
                  ...
                  <br>
                  <h3 class="uk-panel-title" style="text-align: center;">Contact Us</h3>
                  <p class="tm-panel-header-subtitle uk-text-center" style="text-align: center;"><?php echo get_cat_name(7) ?></p>
                  <?php
                  $a = array(
                    'cat' => 7,
                    'order' => ASC
