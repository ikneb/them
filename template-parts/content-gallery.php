                    ...
                    <article class="uk-article" >	
                        <div>		
                            <div class="uk-margin-large-bottom uk-text-center">
                                <h2 class="uk-h1 uk-margin-bottom-remove" style="text-align: center;">Our Gallery</h2>
                            </div>
                            <p style="text-align: center;">
                                <div class="uk-tab-center uk-margin">
                                    <ul id="wk-ba5" class="uk-tab" data-uk-tab>   
                                        <li data-uk-filter="<?php echo get_cat_name(9) ?>"><a href="gallery.html#"><?php echo get_cat_name(9) ?></a></li>
                                        <li data-uk-filter="<?php echo get_cat_name(10) ?>"><a href="gallery.html#"><?php echo get_cat_name(10) ?></a></li>
                                        <li data-uk-filter="<?php echo get_cat_name(11) ?>"><a href="gallery.html#"><?php echo get_cat_name(11) ?></a></li>
                                    </ul>
                                </div>
